...
ACCOUNT_TYPES = (
    ...
    (ACCOUNT_TYPE_SIMPLEIRA, "SIMPLE IRA Account "
                             "(Savings Incentive Match Plans for Employees)"),
    (ACCOUNT_TYPE_SARSEPIRA, "SARSEP Account "
    ...
    (ACCOUNT_TYPE_DEFINEDBENEFIT, "Defined Benefit Account"),
    ...
    (ACCOUNT_TYPE_OTHER, "Other Account"),
)

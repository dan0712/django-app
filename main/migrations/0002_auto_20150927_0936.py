    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                verbose_name='groups', to='auth.Group', blank=True, related_name='user_set', related_query_name='user'),
        ),
        migrations.AddField(
            model_name='user',
            name='user_permissions',
            field=models.ManyToManyField(help_text='Specific permissions for this user.',
                                         verbose_name='user permissions', to='auth.Permission', blank=True,

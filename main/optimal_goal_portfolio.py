...
from numpy import array, zeros, ones, dot, append, mean, cov, transpose
...
def solve_shares_wdw(current_shares, tickers_price, target_allocation, amount):
    ...
    optimized = scipy.optimize.minimize(min_drift_wdw, shares_change, (current_shares, tickers_price, target_allocation),

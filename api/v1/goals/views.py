...
from api.v1.goals.serializers import StatelessPortfolioSerializer
...
class GoalViewSet(ApiViewMixin, viewsets.ModelViewSet):
    ...
    def calculate_portfolio(self, request, pk=None):
        ...
        serializer = serializers.StatelessGoalSettingSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        ...
        try:
            serializer = StatelessPortfolioSerializer(

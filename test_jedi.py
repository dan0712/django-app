...
class AdvisorClientInvitesForm(forms.ModelForm):
    ...
    def save(self, *args, **kw):
        try:
            ...
            invitation = super(AdvisorClientInvitesForm, self).save(*args, **
                                                                    kw)
...
class AdvisorClientInvites(CreateView, AdvisorView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        response.context_data["invite_type"] = invite_type
        return response
...
class CreateNewClientPrepopulatedView(AdvisorView, TemplateView):
    ...
    class form_class(forms.ModelForm):
        ...
        def save(self, *args, **kwargs):
            super(form_class, self).save(*args, **kwargs)
            pass

    def dispatch(self, request, *args, **kwargs):
        return super(CreateNewClientPrepopulatedView, self).dispatch(self, request, *args, **kwargs)
    
    def get(self, request, *args, **kwargs):
        return super(CreateNewClientPrepopulatedView, self).get(request, *args, **kwargs)
    
    def post(self, request, *args, **kwargs):
        return super(CreateNewClientPrepopulatedView, self).post(request, *args, **kwargs)
"""


s=Script(source=source, line=685, column=15)
